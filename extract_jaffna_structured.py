...
try:
    ...
    for page in reader.pages:
        ...
        if 'JAFFNA' in text.upper() or 'ZONE: 02' in text.upper() or 'ZONE:02' in text.upper() or 'NALLUR' in text.upper():
    ...
    # Format output as JS
    with open('jaffna_prayer_data.js', 'w') as f:
        f.write('const JAFFNA_PRAYER_DATA = ')
        json.dump(zone_data, f, indent=4)
        f.write(';\n')

    print("Parsed data saved to jaffna_prayer_data.js")
