...
try:
    ...
    # Trincomalee is Zone 09
    target_pages = []
    for page in reader.pages:
        text = str(page.extract_text() or '')
        if 'TRINCOMALEE' in text.upper() or 'ZONE: 09' in text.upper() or 'ZONE:09' in text.upper():
    ...
    # Format output as JS
    with open('trincomalee_prayer_data.js', 'w') as f:
        f.write('const TRINCOMALEE_PRAYER_DATA = ')
        json.dump(zone_data, f, indent=2)
        f.write(';\n')

    print("Parsed data saved to trincomalee_prayer_data.js")
