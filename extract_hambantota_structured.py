...
try:
    ...
    # Hambantota is Zone 13
    target_pages = []
    for page in reader.pages:
        text = str(page.extract_text() or '')
        if 'HAMBANTOTA' in text.upper() or 'ZONE: 13' in text.upper() or 'ZONE:13' in text.upper():
    ...
    # Format output as JS
    with open('hambantota_prayer_data.js', 'w') as f:
        f.write('const HAMBANTOTA_PRAYER_DATA = ')
        json.dump(zone_data, f, indent=4)
        f.write(';\n')

    print("Parsed data saved to hambantota_prayer_data.js")
