...
try:
    ...
    # Kurunegala is Zone 06
    target_pages = []
    for page in reader.pages:
        text = str(page.extract_text() or '')
        if 'KURUNEGALA' in text.upper() or 'ZONE: 06' in text.upper() or 'ZONE:06' in text.upper():
    ...
    # Format output as JS
    with open('kurunegala_prayer_data.js', 'w') as f:
        f.write('const KURUNEGALA_PRAYER_DATA = ')
        json.dump(zone_data, f, indent=2)
        f.write(';\n')

    print("Parsed data saved to kurunegala_prayer_data.js")
