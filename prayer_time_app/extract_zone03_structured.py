...
try:
    ...
    # Mullaitivu, Kilinochchi, Vavuniya is Zone 03
    target_pages = []
    for page in reader.pages:
        text = str(page.extract_text() or '')
        if 'MULLAITIVU' in text.upper() or 'KILINOCHCHI' in text.upper() or 'VAVUNIYA' in text.upper() or 'ZONE: 03' in text.upper() or 'ZONE:03' in text.upper():
    ...
    # Format output as JS
    with open('zone03_prayer_data.js', 'w') as f:
        f.write('const ZONE03_PRAYER_DATA = ')
        json.dump(zone_data, f, indent=4)
        f.write(';\n')

    print("Parsed data saved to zone03_prayer_data.js")
